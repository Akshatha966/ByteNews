  ...
  return (
    <div className="container mx-auto px-6 py-10 text-center">
      ...
      <p className="mt-4 text-gray-700">
        Welcome to ByteNews. We value your privacy and are committed to protecting your personal information.
      </p>
      ...
      <p className="text-gray-700 mt-2">
        ByteNews retrieves news data from <a href="https://newsapi.org" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">NewsAPI.org</a>. 
        We do not control their data policies.
      </p>

      <h2 className="text-2xl font-semibold mt-6">4. Contact Us</h2>
      <p className="text-gray-700 mt-2">
        If you have any questions, contact us at <a className="text-blue-500 underline">akshatharh.2003@gmail.com</a>.
      </p>

      <p className="mt-8 text-gray-500 text-sm">
        Designed and Developed by Akshatha RH
      </p>
    </div>
  );
};
