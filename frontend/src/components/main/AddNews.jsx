...
const AddNews = () => {
  ...
  const handleImageChange = async (e) => {
    ...
    if (file) {
      ...
      data.append("upload_preset", "ByteNews");
      ...
      {message || error ? (
        ...
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-30 p-2 bg-[#4552e8] text-white rounded-lg cursor-pointer hover:text-gray-300 transition mx-auto block hover:shadow-lg hover:border border-gray-300"
            >
              Add News
            </button>
          </form>
