...
function Header({ isAdmin = false }) {
  ...
  return (
    <header className="bg-[#4552e8] shadow-lg py-4">
      <nav className="container mx-auto flex items-center justify-between px-6">
        <div className="flex items-center ml-6 space-x-5">
          <Link to={isAdmin ? "/admin" : "/news"}>
            <img src="/logo.png" alt="ByteNews Logo" className="w-14 h-auto" />
          </Link>
          <h3
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#4552e8] w-full absolute top-16 left-0 z-10 shadow-lg">
