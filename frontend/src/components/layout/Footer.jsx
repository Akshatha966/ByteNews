...
const Footer = ({ isAdmin = false }) => {
  return (
    <footer className="bg-[#4552e8] text-white py-6 mt-6">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        <div className="text-center md:text-left">
          <h2 className="text-xl font-semibold">ByteNews</h2>
        ...
        <div className="text-sm text-gray-300 mt-4 md:mt-0 text-center md:text-right">
          <p>&copy; 2025 ByteNews. All rights reserved.</p>
          <p className="text-gray-400 text-xs mt-1">Designed & Developed by <span className="font-semibold text-white">Akshatha RH</span></p>
        </div>
      </div>
    </footer>
  );
